...
config :onagal_simple, OnagalSimple.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "GIzixtne67IuPOMQIh58/6gNU/2kwUsoU38a4pEp8fhzQOrPQRwDlvlKy5NNiQkJ",
  watchers: [
...
config :onagal_simple, OnagalSimple.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/onagal_simple/(live|views)/.*(ex)$",
      ~r"lib/onagal_simple/templates/.*(eex)$"
    ]
  ]
...
config :onagal_web, OnagalWeb.Endpoint,
  live_reload: [
    patterns: [
      ~r"priv/static/.*(js|css|png|jpeg|jpg|gif|svg)$",
      ~r"priv/gettext/.*(po)$",
      ~r"lib/onagal_web/(live|views)/.*(ex)$",
      ~r"lib/onagal_web/templates/.*(eex)$"
    ]
  ]
